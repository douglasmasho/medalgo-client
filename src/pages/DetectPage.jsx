          ...
          <main className="max-w-7xl mx-auto py-6 px-4 lg:px-8">
            ...
            >
              ...
              <p className="u-margin-bottom">
                Upload a brain MRI image to detect the presence of a tumor and
                more information about the tumor if it exists
              </p>
                    ...
                    <FilePond
                      ...
                      server={{
                        process: (
                          ...
                          request.open("POST", "http://127.0.0.1:8000/predict");
                          ...
                          request2.onload = async function () {
                            if (
                              ...
                              // the load method accepts either a string (id) or an object
                              const respObj = await JSON.parse(
                                request2.response
                              );
              ...
              <div className="grid grid-2 u-margin-bottom-medium">
                <div className="bg-gray-800 bg-opacity-50 backdrop-blur-md overflow-hidden shadow-lg rounded-xl border border-gray-700 p-5">
                  ...
                  {loading2 ? (
                    ...
                    <>
                      <h3 className="bigger2-text capitalize-text">
                        {classifyRes.predicted_class}{" "}
                        <span className="blue-text">
                          {classifyRes.class_probabilities[
                            classifyRes.predicted_class
                          ].toFixed(2)}
                          %
                        </span>
                      ...
                      <BarGraphCustom
                        dataObj={convertToData(classifyRes.class_probabilities)}
                      />
                    </>
                  ) : (
                    <div
                ...
                <div
                  className="bg-gray-800 bg-opacity-50 backdrop-blur-md overflow-hidden shadow-lg rounded-xl border border-gray-700 p-5"
                  style={{
                    maxHeight: "400px",
                    overflowY: "scroll",
                    overflowX: "hidden",
                  ...
                  {loading2 ? (
                    ...
                    <div className="">
                      {tumorType === "" ? (
                        ...
                        <>
                          <h3 className="bigger-text capitalize-text">
                            {tumorData[tumorType].name}{" "}
                            <span className="blue-text">Information</span>
                          </h3>
                          <p className="u-margin-bottom-small">
                            Sources:
                            {tumorData[tumorType].sources.map((item, index) => (
                              <a
                                href={item.link}
                                key={index}
                                target="_blank"
                          ...
                          <h2 className="u-margin-bottom-small medium-text">
                            What is a {tumorData[tumorType].name}?
                          </h2>
                          {tumorData[tumorType].description
                            .split("\n\n")
                            .map((para, index) => (
                              <p className="u-margin-bottom-small" key={index}>
                                {para}
                              </p>
                            ))}

                          <h2 className="u-margin-bottom-small mt-10 medium-text">
                            Types
                          </h2>
                          ...
                          <p className="u-margin-bottom-small">
                            {tumorData[tumorType].symptomsHeader}
                          </p>

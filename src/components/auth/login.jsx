            ...
            <main className="w-full h-screen flex self-center place-content-center place-items-center white-text">
                <div className="w-96 white-text space-y-5 p-4 shadow-xl border rounded-xl center-vert" >
                    ...
                    <button
                        ...
                        className={`w-full flex items-center justify-center gap-x-3 py-2.5 border rounded-lg text-sm font-medium  ${isSigningIn ? 'cursor-not-allowed' : 'hover:bg-gray-600 transition duration-300 active:bg-gray-800'}`}>

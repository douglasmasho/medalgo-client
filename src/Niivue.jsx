...
import Toolbar from './niivuecomponents/Toolbar.jsx'
import {SettingsPanel} from './niivuecomponents/SettingsPanel.jsx'
import {ColorPicker} from './niivuecomponents/ColorPicker.jsx'
import {NumberPicker} from './niivuecomponents/NumberPicker.jsx'
import { LayersPanel } from './niivuecomponents/LayersPanel.jsx'
import { NiivuePanel } from './niivuecomponents/NiivuePanel.jsx'
import NVSwitch from './niivuecomponents/Switch.jsx'
import LocationTable from './niivuecomponents/LocationTable.jsx'
import Layer from './niivuecomponents/Layer.jsx'
import './Niivue.css'
...
export default function NiiVue(props) {
  ...
  const [rulerColor, setRulerColor] = React.useState(1)
  const [rulerOpacity, setRulerOpacity] = React.useState(1)
